...
const ResetPasswordPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FCF6F5]  items-center justify-center"><br /><br /><br /><br /><br />
      ...
      <div className="max-w-md mx-auto mt-10 bg-white p-6 rounded-lg shadow-lg border border-[#990011]">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            className="w-full p-3 border border-[#990011] rounded mb-4 focus:outline-none focus:ring-2 focus:ring-[#D94E5D]"
