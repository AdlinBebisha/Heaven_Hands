...
import com.example.heavenhands.service.ItemRequestService;
...
public class ItemRequestController {
    ...
    public ResponseEntity<?> listForOrphanage(@PathVariable Long id) {
        if (!service.userRepo.existsById(id)) {
            return ResponseEntity.badRequest().body(Map.of("error", "Orphanage not found"));
        }
        return ResponseEntity.ok(service.repo.findByUserId(id));
    }
